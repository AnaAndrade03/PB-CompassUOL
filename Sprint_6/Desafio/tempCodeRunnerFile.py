...
#lendo os arquivos e mandando para o bucket que acabou de ser criado 
arquivos_para_enviar = [
    r'C:\Users\andra\OneDrive\Área de Trabalho\desafio6\movies.csv',
    r'C:\Users\andra\OneDrive\Área de Trabalho\desafio6\series.csv'                    
]
